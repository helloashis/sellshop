<template>
    <div>
        ...
        <featerproduct-component></featerproduct-component>
		<!-- featured-products section end -->
		<!-- coming product section start -->
		<comingproduct-component></comingproduct-component>
												...
												<div class="quick-image">
														...
														<div class="list-img">
															<div class="product-img tab-content">
																<div class="simpleLens-container tab-pane fade in" id="sin-1">
																	...
																	<a class="simpleLens-image" data-lens-image="assets/img/products/z1.jpg" href="#"><img src="assets/img/products/z1.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
																<div class="simpleLens-container tab-pane active fade in" id="sin-2">
																	<div class="pro-type sell">
																		<span>sell</span>
																	</div>
																	<a class="simpleLens-image" data-lens-image="assets/img/products/z2.jpg" href="#"><img src="assets/img/products/z2.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
																<div class="simpleLens-container tab-pane fade in" id="sin-3">
																	<div class="pro-type">
																		<span>-15%</span>
																	</div>
																	<a class="simpleLens-image" data-lens-image="assets/img/products/z3.jpg" href="#"><img src="assets/img/products/z3.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
																<div class="simpleLens-container tab-pane fade in" id="sin-4">
																	<div class="pro-type">
																		<span>new</span>
																	</div>
																	<a class="simpleLens-image" data-lens-image="assets/img/products/z4.jpg" href="#"><img src="assets/img/products/z4.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
															</div>
														</div>
													</div>
													<div class="quick-thumb">
														<ul class="product-slider">
															<li><a data-toggle="tab" href="#sin-1"> <img src="assets/img/products/s1.jpg" alt="quick view" /> </a></li>
															<li class="active"><a data-toggle="tab" href="#sin-2"> <img src="assets/img/products/s2.jpg" alt="small image" /> </a></li>
															<li><a data-toggle="tab" href="#sin-3"> <img src="assets/img/products/s3.jpg" alt="small image" /> </a></li>
															<li><a data-toggle="tab" href="#sin-4"> <img src="assets/img/products/s4.jpg" alt="small image" /> </a></li>
														</ul>
													</div>
												</div>
											</div>
